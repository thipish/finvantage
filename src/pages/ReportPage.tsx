...
const ReportPage = () => {
  ...
  const [result, setResult] = useState<CreditResult & { aiInsights?: string[]; predictionId?: number } | null>(null);
        ...
        <div className="mb-5 flex items-center gap-3">
          ...
          <div>
            <h2 className="font-heading text-lg font-bold text-foreground">
              {result.aiInsights?.length ? "ML-Powered Financial Insights" : "AI Financial Insights"}
            </h2>
            <p className="text-xs text-muted-foreground">
              {result.aiInsights?.length
                ? "Generated by Random Forest model analysis"
